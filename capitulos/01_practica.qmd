...
Descargar el archivo [`practica1_ambiente.RData`](https://github.com/ee-unr/programacion-1/raw/refs/heads/main/archivos/practica1_ambiente.RData) y guardarlo en la carpeta del proyecto `unidad_1`. Este archivo es de extensión `.RData` y se utiliza para guardar objetos de R. Cuando este archivo se lee con R, se cargan en el *environment* los objetos que tiene almacenados. Vamos a leer este archivo para identificar qué tipo de objetos aparecen en nuestro ambiente. Para abrir este archivo, podemos usar alguna de estas opciones:
...
a. ¿Cuál es la ruta informática o *path* del script `resulucion_practica_1.R` que creaste en el ejercicio 1?
