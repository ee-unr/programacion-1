...
<!-- En múltiples sistemas hay usuarios que pueden acceder a cierto contenido si ingresan a sus cuentas proveyendo la contraseña correcta. Si es incorrecta, el usuario debe intentar una y otra vez, hasta que coincida con el valor registrado o hasta que se llegue a un tope máximo de intentos y la cuenta sea bloqueada. -->

<!-- Vamos a suponer que los estudiantes de Estadística pueden ingresar a un sistema para el cual la contraseña correcta es "amoestadistica". Escribir un algoritmo que inicialmente escriba un mensaje solicitando el ingreso de una contraseña, luego lea el valor provisto por el usuario y finalmente comience un proceso iterativo de verificación: si la contraseña no es correcta, debe anunciar "Contraseña incorrecta. Ingrésela nuevamente" y proceder a la lectura en un nuevo intento. Cuando el usuario provea la contraseña adecuada, se debe mostrar el mensaje "¡Contraseña correcta! Puede continuar con sus estudios.". -->

<!-- Se deben proponer dos algoritmos distintos, considerando los siguientes escenarios: -->

<!-- 1.  El proceso iterativo continúa hasta que la contraseña sea correcta, sin importar la cantidad de intentos. -->
<!-- 2.  El proceso iterativo se detiene luego de cinco intentos fallidos, anunciando que el usuario ha sido bloqueado. -->
