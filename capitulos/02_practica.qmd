...
En un pequeño pueblo en expansión, la población `p0` es igual a 1000 al inicio del año. La población aumenta regularmente un 2% anual. Además, 50 nuevos habitantes se mudan al pueblo cada año. 

a.  ¿Cuántos años tienen que transcurrir para que el pueblo alcance una población mayor o igual a 1200 habitantes?

b.  Escribir un programa en R que permita cambiar los parámetros del problema (la población inicial, población objetivo, tasa de crecimiento anual y cantidad de habitantes que inmigran al pueblo), con el objetivo de calcular la cantidad de años necesarios.  El programa debe devolver una descripción de la situación del problema, y cuántos años llevaría. 
