...
b.  Producto vectorial de dos vectores de dimensión 3
    ...
    #' u × v
    #' 
    #' @details Se detiene con error si alguno de los vectores no tiene dimensión 3.
    #'
    #' @examples
...
#'
#' @return Una matriz con la suma de A y B, o NULL si las dimensiones no coinciden.
#'
#' @examples
#' A <- matrix(1:4, nrow = 2)
#' B <- matrix(5:8, nrow = 2)
...
b.  Encontrar el valor mínimo en una fila específica de una matriz.
    ...
    #'
    #' Esta función busca el valor mínimo dentro de una fila específica de una matriz 
    #' y devuelve el valor junto con el número de columna donde se encuentra.
    #'
    #' @param m Una matriz numérica.
    #' @param fila Un entero que indica el número de fila en la que se desea buscar 
    #' el valor mínimo.
    #'
...
a.  Ordenar matriz por columna en orden descendente.
    ...
    #'
    #' @param m Una matriz
    #' @param col Un entero que indica el índice de la columna por la que se desea 
    #' ordenar.
    #'
    #' @return La matriz ordenada por la columna especificada en orden descendente.
    #' 
    #' @examples
    ...
    *Observaciones*
    ...
    - En lugar de chequear si tiene más de una fila, podríamos directamente poner `for (i in 1:nrow(m))` y `for (j in i:nrow(m))`. Esto funciona también cuando la matriz provista tiene una sola fila, pero en cualquier otro caso implica a hacer comparaciones lógicas de más, tantas como número de fila tenga la matriz.
...
b.  Ordenar matriz por columna en orden ascendente.
    
    ```{r}
    #' Ordenar matriz por columna en orden ascendente
    #'
    #' Esta función ordena las filas de una matriz numérica según los valores
    #' de una columna específica, en orden ascendente.
    #'
    #' @param m Una matriz numérica.
    #' @param col Un entero que indica el índice de la columna por la que se desea 
    #' ordenar.
    #'
    #' @return La matriz ordenada por la columna especificada en orden ascendente.
    #' 
    #' @examples
    #' m <- matrix(c(3, 2, 1, 6, 5, 4), ncol = 2, byrow = TRUE)
    #' ordenar_asc_col(m, 1)
...
c.  Ordenar matriz por fila en orden descendente
    
    ```{r}
    #' Ordenar matriz por fila en orden descendente
    #'
    #' Esta función ordena las columnas de una matriz numérica según los valores
    #' de una fila específica, en orden descendente.
    #'
    #' @param m Una matriz numérica.
    #' @param fila Un entero que indica el índice de la fila por la que se desea 
    #' ordenar.
    #'
    #' @return La matriz ordenada por la fila especificada en orden descendente.
    #' 
    #' @examples
    #' m <- matrix(c(1, 4, 2, 3, 5, 6), nrow = 2, byrow = TRUE)
    #' ordenar_desc_fila(m, 1)
...
#' Un cuadrado mágico es una matriz en la que la suma de los elementos en cada fila,
#' en cada columna y en las dos diagonales principales es igual.
#'
