...
Considerando la función f1 anterior junto con la siguiente función f2, indique si cada una de las siguientes afirmaciones es VERDADERA o FALSA, al evaluar el siguiente programa. 

```{r, eval=FALSE}
# Definición de funciones - SUBALGORITMOS
f1 <- function(x, y) {
  if(y == "operar") {
    x <- x * 2
    rtdo <- x + 100
