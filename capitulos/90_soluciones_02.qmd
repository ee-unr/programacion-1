...
Al final del 2º año habrá:
1070 + 1070 * 0.02 + 50 => 1141 habitantes (*recordar que el número de habitantes es un entero*)
...
año <- 0
poblacion <- p0
while (poblacion < p.objetivo) {
  poblacion <- floor(poblacion + poblacion * tasa/100 + inmigrantes)
  año <- año + 1
}
cat("Con una población inicial de", p0, "habitantes, una tasa de crecimiento anual del",
    tasa, "% \ny", inmigrantes, "nuevos habitantes anuales, se necesitarán",
    año, "años para alcanzar una población de", p.objetivo, "habitantes.", 
    "\nLuego del año", año, ", el pueblo contará con una población de", 
