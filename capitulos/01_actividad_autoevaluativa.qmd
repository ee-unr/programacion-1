...
indique su resultado (VERDADERO o FALSO) para cada una de las siguientes asignaciones de valor para las variables x e y:
...
`r webexercises::hide("Ver explicación")`
Como x = 15 y y = 30, entonces (15 > 30) es FALSE.<br> 
15/2 = 7.5, y (7.5 > 10) también es FALSE.<br>
Sin embargo, !(FALSE) = TRUE. <br>
...
`r webexercises::hide("Ver explicación")`
Como x = 22 y y = 30, entonces (22 > 30) es FALSE.<br> 
22/2 = 11, y (11 > 10) es TRUE.<br>
Sin embargo, !(TRUE) = FALSE. <br>
...
`r webexercises::hide("Ver explicación")`
Como x = 32 y y = 30, entonces (32 > 30) es TRUE.<br> 
32/2 = 16, y (16 > 10) es TRUE.<br>
Sin embargo, !(TRUE) = FALSE. <br>
...
`r webexercises::hide("Ver explicación")`
**Inicialización:**<br>
**1) var1 recibe el valor 100.**<br>
**2) var2 almacena el resto de dividir var1 entre 30:**<br>
- Como 30 × 3 = 90 y 100 − 90 = 10, entonces:<br>
- var2 = 10.<br>
**3) var3 guarda la suma de var1 y var2:**<br>
 - 100 + 10 = 110.<br>
**4) Modificación de var3:**<br>
- Se actualiza var3 restando 3 veces var2:<br>
- 110 − (3 × 10) = 80.<br>
**5) Actualización final de var1:**<br>
- var1 toma el valor de var3 + 20:<br>
- 80 + 20 = 100.<br>
...
**2025_venta_inmueble:** En general no es buena práctica que los nombres de variables
comiencen con un número en ningún lenguaje de programación. R y la mayoría de lenguajes no lo permiten, y aunque algunos como PHP lo soportan técnicamente, dificulta la lectura y puede causar errores.
...
**valorVentaInmueble2025:** Aunque muchos lenguajes utilizan camelCase para nombrar variables, en R la convención más clara y extendida es snake_case (con guiones bajos). Funciona, pero no sigue el estilo típico de R.

**operación_Año2025:** Este nombre contiene un acento ("ó") y la letra "ñ", lo que puede causar conflictos en entornos que no usen UTF-8 como codificación predeterminada. Para evitar errores, es mejor evitar caracteres no ASCII. Ademas utiliza mayusculas lo que puede complicar innecesariamente la escritura del nombre de la variable.
