...
En [este enlace](https://github.com/ee-unr/programacion-1/blob/main/archivos/programa.pdf) podés consultar el programa para esta asignatura.
...
Más detalles sobre cada componente evaluativo pueden encontrarse en el [programa](https://github.com/ee-unr/programacion-1/blob/main/archivos/programa.pdf) o en el [aula virtual](https://comunidades3.campusvirtualunr.edu.ar/course/view.php?id=4893).
